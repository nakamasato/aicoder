...
func (p *Planner) GeneratePlan(ctx context.Context, query string, summary *summarizer.OverallSummary, files []file.File, currentPlan *ChangesPlan, review string) (*ChangesPlan, error) {
